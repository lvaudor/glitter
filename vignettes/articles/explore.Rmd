...
But in any case, you could get inspired by the Chapter 11 "SPARQL cookbook" of the ["Learning SPARQL" book by Bob DuCharme](https://www.goodreads.com/book/show/18198885-learning-sparql).
Let's go through an example.

## Asking for a subset of all triples

In the code below we'll ask for 50 triples.
