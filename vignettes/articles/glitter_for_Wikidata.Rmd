...
If the Wikidata unique identifier is not particularly useful, one can use the argument `.overwrite=FALSE` so that only labels will be returned, under the shorter name `items`:
