...
#' spq_init() %>%
#'   spq_add(.triple_pattern = "?item wdt:P31/wdt:P279* wd:Q4022", label = c("?item")) %>%
#'   spq_add(.triple_pattern = "?item wdt:P2043 ?length") %>%
#'   spq_add(.triple_pattern = "?item wdt:P625 ?location") %>%
...
#' spq_init() %>%
#'   spq_add(.triple_pattern = "?oeuvre dcterms:creator ?auteur") %>%
#'   spq_add(.triple_pattern = "?auteur bio:death ?mort") %>%
#'   spq_add(.triple_pattern = "?auteur foaf:familyName ?nom") %>%
